...
class ProductVariants extends Component
{
    ...
    {
        return Feature::where('option_id', $this->variant['option_id'])->orderby('order')->get();
    }
    ...
    public function save()
    {
        $this->validate([
            ...
            'variant.features.*.order' => 'required',
        ]);
    ...
    public function feature_change($index)
    {
        ...
        if ($feature) {
            ...
            $this->variant['features'][$index]['order'] = $feature->order;
        }
    }
    ...
    public function generarVariantes()
    {
        ...
        $this->dispatch('variant_generated');
    }
