<!--
### TIMID0x - 2023-08-01T12:22:31.000-05:00
-->
                    ...
                    <div class="col">
                        ...
                        <div class="card shadow-lg mt-2">
                            <div class="card-body p-5">
                                ...
                                <form action="{{ route('post.postcreate') }}" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="featured_image" type="text"
                                            ...
                                            name="featured_image"
                                            value="{{ old('featured_image', 'https://timid0x.net/assets/images/default-featured-image.jpg') }} "
