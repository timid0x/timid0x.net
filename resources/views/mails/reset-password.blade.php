<!DOCTYPE html>
<!--
### TIMID0x - 2023-06-05T12:21:46.000-05:00
-->
                ...
                <table role="presentation"
                    ...
                    <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                        <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                             <span style="font-weight: bold; padding-top: 10px;"> Recover email </span>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            We've received a request to reset the password, If you do not recognize this email, proceed to delete and report to: timid0x.player@gmail.com
                                            </p>
                                        <p
                                        ...
                                        <p style="text-align: center;">
                                            <a href="{{'http://timid0x.net/forgot-password/'.$user['token']}}" class="btn">Reset your password</a>
                                        </p>
