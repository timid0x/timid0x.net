        ...
        <div class="container">
            <div class="row">
                ...
                <div class="h-75 overflow-auto">
                    ...
                    <p>At timid0x.net, accessible from timid0x.net, one of our main priorities is the privacy of our
                        visitors. This Privacy Policy document contains types of information that is collected and recorded
                        by timid0x.net and how we use it.</p>

                    <p>If you have additional questions or require more information about our Privacy Policy, do not
                        hesitate to contact us.</p>

                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                        with regards to the information that they shared and/or collect in timid0x.net. This policy is not
                    ...
                    <p>If you contact us directly, we may receive additional information about you such as your name, email
                        address, the contents of the message and/or attachments you may send us, and any other
                    ...
                    <p>When you register for an Account, we may ask for your contact information, including items such as
                        name (username on game) *don't use real name*, email address, and country.</p>
                    ...
                    <ul>
                        ...
                        <li>Communicate with you, either directly to provide you with updates and other information relating to the website.
                            Only if it's necesary
                        </li>
                        <li>Send you emails, as recover password process, if you forget everything :(</li>

                    </ul>

                    <h2>Log Files</h2>

                    <p>timid0x.net follows a standard procedure of using log files. These files log visitors when they visit
                        ...
                        demographic information. Hosting and logs stay on AWS services + Cloudflare.</p>

                    <h2>Cookies and Web Beacons</h2>

                    <p>Like any other website, timid0x.net uses "cookies". These cookies are used to store information
                        ...
                        on visitors' browser type and/or other information. Hey ... we will only use it for visit 
                        statistics via Google Analytics</p>


                    <h2>Third Party Privacy Policies</h2>

                    <p>timid0x.net's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <p>Request that a business that sells a consumer's personal data, Hey ... We NOT sell the consumer's personal data.
                    </p>
                    ...
                    <p>timid0x.net does not knowingly collect any Personal Identifiable Information from children under the
                    ...
                    <p>Pokémon Go is the registered trademark of Niantic. Pokémon is registered trademark of The Pokémon
                        Company. This website is not affiliated with Niantic or The Pokémon Company.</p>

                    <p> &nbsp; </p>
                    <h2>Best Regards</h2>
                    <img src="{{ asset('assets/images/signature_x6v1er.png') }}" alt="" width="250" height="150">

                    <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at timid0x.player@gmail.com</p>


                    <p><h3>Change Log</h3></p>
                    <p>
                        <li>2023-06-03: Initial release</li>
                        <li>2023-06-09: Fix Layout on main and leaderboard, number human readable </li>
                        <li>2023-06-12: Fix group input by numbers </li>
                        <li>2023-07-08: Language switch ... EN / ES</li>   
